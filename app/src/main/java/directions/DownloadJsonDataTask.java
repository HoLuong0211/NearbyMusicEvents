...
public class DownloadJsonDataTask extends AsyncTask<String, Void, String> {
    ...
    private DirectionsJSONParserTask.OnJSONParserCompleteListener mParserCompleteListener;

    public DownloadJsonDataTask(DirectionsJSONParserTask.OnJSONParserCompleteListener listener){
